      ...
      <header class="page-header flexible parallax text-align-center parallax-overlay">
        <section>
          <div class="container">
            <div class="row">
              <div class="col-md-12">
                <h1><?php echo ($row->id) ? "Update" : "Add";?> Subject</h1>
              </div>
            </div>
          </div>
        </section>
            ...
            <form method="post" action="" onsubmit="return validate_form();">
             ...
             <div class="row">
                <div class="form-group">  
                    <div class="col-md-12"> 
                        <h3 class="mb-5">Subject Name:</h3>
                        <input type="text" name="subject_name" id="subject_name" value="<?php echo $row->subject_name; ?>" class="form-control input-lg" placeholder="Enter Subject Name"/>
                    </div>  
                </div>
              </div>
              <div class="row">
                <div class="form-group">
                  <div class="col-md-12">
                   <input type="hidden" name="id" id="id" value="<?php echo $row->id; ?>"/>
                    <input type="submit" name="submit" class="btn btn-primary btn-lg" value="<?php echo ($row->id) ? "Update" : "Add";?> Subject"/>
                  </div>
                </div>
              </div>
              </div>
